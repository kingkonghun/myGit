...
class BadBank extends Bank{
	@Override//어노테이션 이라고 하며 컴파일러에게 추가적인 정보를 제공하는 메타데이터
	//주석으로 활용하거나 또는 프로그램에게 특정 기능을 정의하거나 실행하도록 정보 제공용으로 사용
	//스프링에서는 본격적으로 활용하낟.
...
public class BankTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("nomal의 이자율 : "+b2.getInterestRate());
		System.out.println("good의 이자율 : "+b3.getInterestRate());
