...
public class ListProdEx {
	public static void main(String[] args) {
		...
		list.add(new ProdEx("TV", "oled01", "LG", 300, 10));//던지고
	...
	static void print(Map<String, Object> map) {//받고 데이터 타입 Map<>
		ArrayList<ProdEx> list2=(ArrayList<ProdEx>)map.get("list");//명시적 형변환 좌우같게
